...
const Header = (props) => {
  return (
    <header className="app">
      <Link to='/'>
        <h1 className={style.logo}>MagaZ</h1>
      </Link>
      ...
      <nav>
        ...
        <div className={style['count-sector']}>
          ...
          <div className={style['count-cart-items']}>
              <img src='./img/basket.svg' alt="heart" onClick={props.openCart}></img>
              <span>{props.cartItems.length}</span></div>
        </div>
